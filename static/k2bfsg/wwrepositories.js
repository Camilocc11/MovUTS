...
gx.define('k2bfsg.wwrepositories', false, function () {
   this.ServerClass =  "k2bfsg.wwrepositories" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV22RowsPerPage_Grid=gx.fn.getIntegerValue("vROWSPERPAGE_GRID",'.') ;
   ...
   this.s182_client=function()
   {
      ...
      if ( ( this.AV7CurrentPage_Grid <= 1 ) && ( this.AV15HasNextPage_Grid == false ) )
      {
   ...
   this.e192b1_client=function()
   {
      this.clearMessages();
      if ( gx.fn.getCtrlProperty("GRIDSETTINGS_CONTENTOUTERTABLEGRID","Visible") == false )
      {
         this.AV11GridSettingsRowsPerPage_Grid = gx.num.trunc( this.AV22RowsPerPage_Grid ,0) ;
      ...
      this.refreshOutputs([{ctrl:'vGRIDSETTINGSROWSPERPAGE_GRID'},{av:'AV11GridSettingsRowsPerPage_Grid',fld:'vGRIDSETTINGSROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'gx.fn.getCtrlProperty("GRIDSETTINGS_CONTENTOUTERTABLEGRID","Visible")',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'}]);
      return gx.$.Deferred().resolve();
   };
   ...
   {
      this.call("com.movuts.k2bfsg.repositoryconfiguration", [this.AV18Id]);
   };
   ...
   {
      this.call("com.movuts.k2bfsg.entryrepository", ["DLT", this.AV18Id]);
   };
   this.e202b1_client=function()
   {
      this.clearMessages();
      this.s232_client();
      this.refreshOutputs([]);
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",78,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"k2bfsg.wwrepositories",[],false,1,false,true,0,false,false,false,"",0,"px",0,"px","Nueva fila",false,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   var GridContainer = this.GridContainer;
   GridContainer.addSingleLineEdit("Id",79,"vID","Id","","Id","int",0,"px",12,12,"right",null,[],"Id","Id",false,0,false,false,"Attribute_Grid",1,"K2BToolsGridColumn");
   GridContainer.addSingleLineEdit("Name",80,"vNAME","Nombre","","Name","char",0,"px",254,80,"left",null,[],"Name","Name",true,0,false,false,"Attribute_Grid",1,"K2BToolsGridColumn InvisibleInExtraSmallColumn");
   GridContainer.addBitmap("&Update_action","vUPDATE_ACTION",81,20,"px",17,"px","e212b2_client","","","Image_Action","K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover");
   GridContainer.addBitmap("&Delete_action","vDELETE_ACTION",82,20,"px",17,"px","e222b2_client","","","Image_Action","K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover");
   ...
   GXValidFnc[32]={ id:32 ,lvl:0,type:"char",len:100,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vGENERICFILTER_GRID",gxz:"ZV10GenericFilter_Grid",gxold:"OV10GenericFilter_Grid",gxvar:"AV10GenericFilter_Grid",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.AV10GenericFilter_Grid=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV10GenericFilter_Grid=Value},v2c:function(){gx.fn.setControlValue("vGENERICFILTER_GRID",gx.O.AV10GenericFilter_Grid,0)},c2v:function(){if(this.val()!==undefined)gx.O.AV10GenericFilter_Grid=this.val()},val:function(){return gx.fn.getControlValue("vGENERICFILTER_GRID")},nac:gx.falseFn};
   ...
   GXValidFnc[41]={ id: 41, fld:"GRIDSETTINGS_LABELGRID",grid:0,evt:"e192b1_client"};
   ...
   GXValidFnc[61]={ id:61 ,lvl:0,type:"int",len:4,dec:0,sign:false,pic:"ZZZ9",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vGRIDSETTINGSROWSPERPAGE_GRID",gxz:"ZV11GridSettingsRowsPerPage_Grid",gxold:"OV11GridSettingsRowsPerPage_Grid",gxvar:"AV11GridSettingsRowsPerPage_Grid",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"combo",v2v:function(Value){if(Value!==undefined)gx.O.AV11GridSettingsRowsPerPage_Grid=gx.num.intval(Value)},v2z:function(Value){if(Value!==undefined)gx.O.ZV11GridSettingsRowsPerPage_Grid=gx.num.intval(Value)},v2c:function(){gx.fn.setComboBoxValue("vGRIDSETTINGSROWSPERPAGE_GRID",gx.O.AV11GridSettingsRowsPerPage_Grid)},c2v:function(){if(this.val()!==undefined)gx.O.AV11GridSettingsRowsPerPage_Grid=gx.num.intval(this.val())},val:function(){return gx.fn.getIntegerValue("vGRIDSETTINGSROWSPERPAGE_GRID",'.')},nac:gx.falseFn};
   GXValidFnc[62]={ id: 62, fld:"",grid:0};
   GXValidFnc[63]={ id: 63, fld:"",grid:0};
   GXValidFnc[64]={ id: 64, fld:"GRIDSETTINGS_SAVEGRID",grid:0,evt:"e112b2_client"};
   GXValidFnc[66]={ id: 66, fld:"ACTIONS_GRID_TOPRIGHT",grid:0};
   GXValidFnc[69]={ id: 69, fld:"ADD",grid:0,evt:"e202b1_client"};
   ...
   GXValidFnc[79]={ id:79 ,lvl:2,type:"int",len:12,dec:0,sign:false,pic:"ZZZZZZZZZZZ9",ro:0,isacc:0,grid:78,gxgrid:this.GridContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vID",gxz:"ZV18Id",gxold:"OV18Id",gxvar:"AV18Id",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'number',v2v:function(Value){if(Value!==undefined)gx.O.AV18Id=gx.num.intval(Value)},v2z:function(Value){if(Value!==undefined)gx.O.ZV18Id=gx.num.intval(Value)},v2c:function(row){gx.fn.setGridControlValue("vID",row || gx.fn.currentGridRowImpl(78),gx.O.AV18Id,0);if (typeof(this.dom_hdl) == 'function') this.dom_hdl.call(gx.O);},c2v:function(row){if(this.val(row)!==undefined)gx.O.AV18Id=gx.num.intval(this.val(row))},val:function(row){return gx.fn.getGridIntegerValue("vID",row || gx.fn.currentGridRowImpl(78),'.')},nac:gx.falseFn};
   GXValidFnc[80]={ id:80 ,lvl:2,type:"char",len:254,dec:0,sign:false,ro:0,isacc:0,grid:78,gxgrid:this.GridContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vNAME",gxz:"ZV20Name",gxold:"OV20Name",gxvar:"AV20Name",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){if(Value!==undefined)gx.O.AV20Name=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV20Name=Value},v2c:function(row){gx.fn.setGridControlValue("vNAME",row || gx.fn.currentGridRowImpl(78),gx.O.AV20Name,0);if (typeof(this.dom_hdl) == 'function') this.dom_hdl.call(gx.O);},c2v:function(row){if(this.val(row)!==undefined)gx.O.AV20Name=this.val(row)},val:function(row){return gx.fn.getGridControlValue("vNAME",row || gx.fn.currentGridRowImpl(78))},nac:gx.falseFn};
   GXValidFnc[81]={ id:81 ,lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:78,gxgrid:this.GridContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vUPDATE_ACTION",gxz:"ZV26Update_Action",gxold:"OV26Update_Action",gxvar:"AV26Update_Action",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){if(Value!==undefined)gx.O.AV26Update_Action=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV26Update_Action=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vUPDATE_ACTION",row || gx.fn.currentGridRowImpl(78),gx.O.AV26Update_Action,gx.O.AV36Update_action_GXI)},c2v:function(row){gx.O.AV36Update_action_GXI=this.val_GXI();if(this.val(row)!==undefined)gx.O.AV26Update_Action=this.val(row)},val:function(row){return gx.fn.getGridControlValue("vUPDATE_ACTION",row || gx.fn.currentGridRowImpl(78))},val_GXI:function(row){return gx.fn.getGridControlValue("vUPDATE_ACTION_GXI",row || gx.fn.currentGridRowImpl(78))}, gxvar_GXI:'AV36Update_action_GXI',nac:gx.falseFn,evt:"e212b2_client"};
   GXValidFnc[82]={ id:82 ,lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:78,gxgrid:this.GridContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vDELETE_ACTION",gxz:"ZV8Delete_Action",gxold:"OV8Delete_Action",gxvar:"AV8Delete_Action",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){if(Value!==undefined)gx.O.AV8Delete_Action=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV8Delete_Action=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vDELETE_ACTION",row || gx.fn.currentGridRowImpl(78),gx.O.AV8Delete_Action,gx.O.AV37Delete_action_GXI)},c2v:function(row){gx.O.AV37Delete_action_GXI=this.val_GXI();if(this.val(row)!==undefined)gx.O.AV8Delete_Action=this.val(row)},val:function(row){return gx.fn.getGridControlValue("vDELETE_ACTION",row || gx.fn.currentGridRowImpl(78))},val_GXI:function(row){return gx.fn.getGridControlValue("vDELETE_ACTION_GXI",row || gx.fn.currentGridRowImpl(78))}, gxvar_GXI:'AV37Delete_action_GXI',nac:gx.falseFn,evt:"e222b2_client"};
   ...
   this.setVCMap("AV22RowsPerPage_Grid", "vROWSPERPAGE_GRID", 0, "int", 4, 0);
   ...
   GridContainer.addRefreshingVar({rfrVar:"AV22RowsPerPage_Grid"});
   ...
   GridContainer.addRefreshingParm({rfrVar:"AV22RowsPerPage_Grid"});
   GridContainer.addRefreshingParm({rfrVar:"AV17I_LoadCount_Grid"});
   this.Initialize( );
});
gx.wi( function() { gx.createParentObj(k2bfsg.wwrepositories);});
