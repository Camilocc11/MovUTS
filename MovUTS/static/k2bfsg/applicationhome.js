...
gx.define('k2bfsg.applicationhome', false, function () {
   this.ServerClass =  "k2bfsg.applicationhome" ;
   ...
   this.GXLastCtrlId =8;
   this.K2BCONTROLBEAUTIFY1Container = gx.uc.getNew(this, 9, 0, "K2BControlBeautify", "K2BCONTROLBEAUTIFY1Container", "K2bcontrolbeautify1", "K2BCONTROLBEAUTIFY1");
...
gx.wi( function() { gx.createParentObj(k2bfsg.applicationhome);});
