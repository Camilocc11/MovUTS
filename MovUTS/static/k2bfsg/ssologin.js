...
gx.define('k2bfsg.ssologin', false, function () {
   this.ServerClass =  "k2bfsg.ssologin" ;
   ...
   this.Events = {"e143c2_client": ["ENTER", true] ,"e153c2_client": ["CANCEL", true]};
   this.EvtParms["REFRESH"] = [[],[]];
   this.EvtParms["START"] = [[],[]];
   this.Initialize( );
});
gx.wi( function() { gx.createParentObj(k2bfsg.ssologin);});
